...
?>
		  ...
		  <div class="md">
		    <!-- START 'DisplayNews by BK 2.0RC1' -->
			  <ul>
			    <li>
			      <h2>
			        <a href="opisanie.otkatnie-vorota.php" class="md_title_otkt1">
			          Описание
			        </a>
			      </h2>
			      <p>Описание откатных ворот, применение, назначение, их виды конструкции и дополнительные опции откатных ворот<br><a href="primenenie.garazhnie-vorota.php" class="readon">Подробнее</a><br>&nbsp;</p>
		  ...
		  <div class="md">
			...
			<!-- START 'DisplayNews by BK 2.0RC1' -->
			  <ul>
			    <li>
			      ...
			      <p>Фотогалерея объектов, а также различных возможных вариантов монтажа откатных ворот<br><a href="photo.viezdnie-vorota.php" class="readon">Подробнее</a><br>&nbsp;</p>
				  <div style="clear: both;"></div>
				</li>
			  </ul>
			<!-- END 'DisplayNews by BK 2.0RC1' -->
			...
			<!-- START 'DisplayNews by BK 2.0RC1' -->
			  <ul>
			    <li>
			      <h2>
			        <a href="preimushestva.otkatnie-vorota.php#tag" class="md_title_rasp2">
			          Преимущества
			        </a>
			      </h2>
			      <p>Преимущества откатных ворот<br><a href="preimushestva.otkatnie-vorota.php" class="readon">Подробнее</a><br>&nbsp;</p>
				  <div style="clear: both;"></div>
				</li>
			  </ul>
			<!-- END 'DisplayNews by BK 2.0RC1' -->
      ...
      <!-- START 'DisplayNews by BK 2.0RC1' -->
			  <ul>
			    <li>
			      <h2>
			        <a href="http://opengate.com.ua/1002-otkatnye-vorota.php" class="md_title_automatics">
			          Автоматика
			        </a>
			      </h2>
			      <p><a href="catalog.php" class="link">Качественная автоматика NICE</a> для откатных ворот в Черновцах <br><a href="http://opengate.com.ua/1002-otkatnye-vorota.php" class="readon">Подробнее</a><br>&nbsp;</p>
				  <div style="clear: both;"></div>
				</li>
			  </ul>
			<!-- END 'DisplayNews by BK 2.0RC1' -->
