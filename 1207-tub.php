...
$page_title = "Электропривод TUB для откатных ворот в Черновцах: автоматика для ворот Nice Черновцы - OpenGATE";
$page_description = "Характеристики электропривода TUB. OpenGATE подберет необходимую автоматику для откатных ворот в Черновцах, установка автоматики на откатные ворота. ";
...
$breadcrumb = '
            ...
            <a href="1207-tub.php" title="Электропривод TUB для распашных ворот">
              Электропривод TUB
          	</a>';
...
?>
        ...
        <div id="container">        
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul class="group_open">
                    ...
                    <li>
                      <a href="http://opengate.com.ua/1207-tub.php" class="group_active">TUB</a>
                    </li>
                  </ul>
                </li>
                <li>
          ...
          <div class="catcontent center"> 
            ...
            <h1>Электропривод TUB для откатных ворот в Черновцах</h1>
            
            <div style="float:left; ">
              <img src="store/otkatnye/tub1.jpg" /> 
            </div>
            <div class="clear"></div>
            <div style="float:left;">              
              <p>Для откатных ворот массой
                до 3500кг.</p>
              <p>Идеально подходит для
                промышленного применения.</p>
              <p>Нереверсивный электромеханический двигатель,
                400 В пер.тока, со встроенным
                блоком управления Mindy A500.</p>
              <p><strong>Мощный:</strong> 550 Вт потребляемой
                мощности и свыше 400 Нм максимального
                пускового момента.</p>
              <p><strong>Функциональность и безопасность:</strong>
                программируемый, электромеханический
                тормоз для устранения инерции ворот;
                двигатель с принудительной вентиляцией
                для увеличения интенсивности работы;
                дополнительная плата PIU для расширения
                базовых функций, возможность замедления
                двигателя.</p>
              <p>Максимальный срок службы<br>
                и бесшумность шестерен из металла
                и бронзы.</p>
              <p><strong>Усовершенствованный:</strong> Tub отвечает
                всем потребностям управления благодаря
                функциям, которые могут выбираться при
                помощи dip-выключателя.</p>
              <p>Практичный: механизм разблокировки
                c рычагом.</p>
            </div>
             ...
             <div class="catalog-item-offers">
      				...
      				<table>
      					...
      					<tr><td class="left"><strong>Общие электрические параметры:</strong></td></tr>
      							<tr><td class="model_attributes_name">Питание (В пер.тока, 50 Гц)</td><td>230</td></tr><tr><td class="model_attributes_name">Потребление (А)</td><td>1,7</td></tr><tr><td class="model_attributes_name">Мощность (Вт)</td><td>400</td></tr><tr><td class="model_attributes_name">Встроенный конденсатор (мкФ)</td><td>12</td></tr>					<tr><td class="left"><strong>Рабочие характеристики:</strong></td></tr>		
      							<tr><td class="model_attributes_name">Скорость (м/с)</td><td>0,18</td></tr><tr><td class="model_attributes_name">Усилие (Н)</td><td>500</td></tr><tr><td class="model_attributes_name">Рабочий цикл (циклов/час)</td><td>9</td></tr>							
      					<tr><td class="left"><strong>Общие данные и размеры:</strong></td></tr>		
      							<tr><td class="model_attributes_name">Класс защиты (IP)</td><td>44</td></tr><tr><td class="model_attributes_name">Рабочая температура (°C min/max)</td><td>-20/+50</td></tr><tr><td class="model_attributes_name">Размеры (мм)</td><td>250x195x290 h</td></tr><tr><td class="model_attributes_name">Масса (кг)</td><td>8</td></tr>										
      					</tbody>
      				</table>
            ...
            <h4>Схема монтажа:</h4>
            <br>
            <img src="store/otkatnye/scheme_tub.jpg" width="600" height="290" alt="Схема монтажа электропривода откатных ворот TUB">
            <br>
            <br>
            ...
            ?>
              ...
              <div class="feedBlock">
                ...
                <form name="feedback" action="send_order.php" method="POST" id="form_id" onsubmit="javascript:return validate('form_id','email');">
                    <input type="hidden" name="return" value="1207-tub.php" />
                    <span>
