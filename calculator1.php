...
$page_title = "Калькулятор: расчет стоимости гаражных ворот";
$page_description = "Калькулятор, расчет стоимости гаражных ворот от OpenGATE";
            ...
            <span id="message" style="color: red; font-weight: bold; padding-bottom: 10px; display: block"></span>
                  ...
                  <td style="padding: 4px; text-align: center" width="320">                
                    ...
                    <img src="img/empty230x100.gif" id="img4" width="230" height="100" alt="" />                   
                      ...
                      <br />
                      <a href="http://www.opengate.com.ua/calculator.php#print"><img onClick="javascript:Order();" border="0" src="img/printbtn.gif" id="pimg" onMouseOver="SetPrintImage('printbtn_on.gif')" onMouseOut="SetPrintImage('printbtn.gif')" /></a>                            										
									</td>
								</tr>
							</table>
						</form>           
