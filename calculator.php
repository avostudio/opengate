...
$page_title = "Стоимость гаражных ворот Черновцы (калькулятор) узнать цену на гаражные ворота в Черновцах - OpenGATE";
$page_description = "Какова цена гаражных ворот в Черновцах? Калькулятор позволит произвести расчет стоимости гаражных ворот от OpenGATE в режиме онлайн.";
$page_keywords = "Калькулятор, стоимость гаражных ворот";
...
$breadcrumb = '
            ...
            <a href="nadezhnost.garazhnie-vorota.php" title="Калькулятор, расчет стоимости гаражных ворот от OpenGATE">
              Калькулятор стоимости
          	</a>';

include_once("header.calculator.php");
...
<p>
 ...
 Необходимо ввести лишь данные и выбрать нужные опции. Вы можете рассчитать цену на гаражные ворота, 
 а также узнать цену на промышленные ворота в Черновцах.
</p>          
...
function Calculate()
            ...
            <span id="message" style="color: red; font-weight: bold; padding-bottom: 10px; display: block"></span>
                      ...
                      <tr onMouseOver="SetImage('peremichka.gif')" onMouseOut="SetImage('vorota.gif')">
                            ...
                            <option value="2">Промышленные</option>
                          </select>
												</td>
											</tr>
                      <tr>
                  ...
                  <td style="padding: 4px; text-align: center" width="320">                
                    ...
                    <img src="img/empty230x100.gif" id="img4" width="230" height="100" alt="" />                   
                      ...
                      <br />
                      <a href="calculator.php#"><img onClick="javascript:Order();" border="0" src="img/printbtn.gif" id="pimg" onMouseOver="SetPrintImage('printbtn_on.gif')" onMouseOut="SetPrintImage('printbtn.gif')" /></a>                            										
									</td>
								</tr>
							</table>
						</form>           
